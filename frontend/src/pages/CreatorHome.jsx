// The creator's home.
//
// Its own file since the app was split by route: `/dashboard` is two surfaces
// behind one path, and while this lived in `Dashboard.jsx` beside the
// dispatcher, a brand opening their own home downloaded the whole creator
// dashboard to get there — and vice versa.
//
...
export default function CreatorHome({ user, justOnboarded }) {
